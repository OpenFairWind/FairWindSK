...
The English, French, Spanish, and Italian owner manuals are maintained as parallel
LaTeX sources under `docs/manual`. Update all four manuals whenever a
...
uploads all four PDFs as artifacts. The workflow runs automatically when manual,
